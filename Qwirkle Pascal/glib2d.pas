...
Const
    ...
    BLUE            : gColor = (r : 0;   g : 0;   b : 255; a : 200);
	...
	BOUTEILLE		: gColor = (r : 9; g : 106; b : 14; a : 255);
    ...
    COULEUR1		: gColor = (r : 15;  g : 61; b : 177;   a : 200); //bleu
    COULEUR2		: gColor = (r : 220; g : 79;	b : 25; a : 200); //orange
    COULEUR3		: gColor = (r : 202; g : 38; b : 109; a : 200); //rose
    COULEUR4		: gColor = (r : 144; g : 12; b : 63; a : 200); //vin
    COULEUR5		: gColor = (r : 134; g : 157; b : 13; a : 200); //vert pomme
    COULEUR6		: gColor = (r : 23; g : 166; b : 130; a : 200); //vert d'eau
   	COULEUR7		: gColor = (r : 92; g : 24; b : 69; a : 255); //bordeau
    COULEUR8		: gColor = (r : 200; g : 53; b : 51; a : 200); //pamplemousse
    COULEUR9		: gColor = (r : 11; g : 17; b : 146; a : 200); //bleu cobalt
    COULEUR10		: gColor = (r : 109; g : 40; b : 0; a : 200); //brun
    COULEUR11		: gColor = (r : 12; g : 134; b : 145; a : 200); //bleu canard
    COULEUR12		: gColor = (r : 216; g : 8; b : 33; a : 200); //rouge cerise
